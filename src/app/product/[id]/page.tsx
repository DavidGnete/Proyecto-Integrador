...
export default function ProductPage() {
  ...
  return (
    <main>
      ...
      <section className="pt-20 min-h-screen bg-gradient-to-br from-slate-50 via-white to-amber-50/30 relative overflow-hidden">
              ...
              <div className="p-6 lg:p-8 lg:pl-4 flex flex-col">
                ...
                <div className="mt-8 pt-6 border-t border-slate-100">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <button 
                      onClick={() => !isAuthenticated ? router.push('/login') : alert('Funcionalidad de reserva próximamente')}
                    ...
                    <button className="py-4 px-6 rounded-xl border-2 border-slate-200 text-slate-700 font-semibold hover:border-slate-300 hover:bg-slate-50 transition-all duration-300 flex items-center justify-center gap-2">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button 
                      onClick={() => !isAuthenticated ? router.push('/login') : alert('Funcionalidad de pago próximamente')}
                      className="py-4 px-6 rounded-xl border-2 border-amber-200 bg-gradient-to-r from-amber-50 to-orange-50 text-amber-700 font-semibold hover:from-amber-100 hover:to-orange-100 transition-all duration-300 flex items-center justify-center gap-2"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
